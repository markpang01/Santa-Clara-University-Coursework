    sa::_iterativeUtils::setSkipIterations  /DCNFS/users/student/mpang/simulation/Fourbit,testbenchschematic,schematic/history_1/simulation/default/HSPICE/nominal/results {}
    catch {wf::_scalarValueDB::setCurrentDbPath /DCNFS/users/student/mpang/simulation/Fourbit,testbenchschematic,schematic/history_1/simulation/default/HSPICE/nominal/results ""}
...
namespace eval ss {
    ...
    sa::_resultsDatabase::_loadSetupForMeasurementCalculation [getActiveTestbench] /DCNFS/users/student/mpang/simulation/Fourbit,testbenchschematic,schematic/history_1/simulation/default/HSPICE/nominal HSPICE
    sa::_utils::setDataDir -of [getActiveTestbench] -value /DCNFS/users/student/mpang/simulation/Fourbit,testbenchschematic,schematic/history_1/simulation/default/HSPICE/nominal 
    set session [getActiveSession]
    set sessionScope [sa::_utils::getSessionScope $session]
    set prefsFile [file join [file dirname /DCNFS/users/student/mpang/simulation/Fourbit,testbenchschematic,schematic/history_1/simulation/default/HSPICE/nominal/results] [::sa::_coreUtils::getSavedSessionPrefsFileName]]
    ...
    proc _runMeasurements {} {
        ...
        sa::_resultsDatabase::_doRunMeasurements /DCNFS/users/student/mpang/simulation/Fourbit,testbenchschematic,schematic/history_1/simulation/default/HSPICE/nominal/resultsDatabase false 1 /DCNFS/users/student/mpang/simulation/Fourbit,testbenchschematic,schematic/history_1/simulation/default/HSPICE/nominal/results /DCNFS/users/student/mpang/simulation/Fourbit,testbenchschematic,schematic/history_1/simulation/default/HSPICE/nominal/results 1 false
        } ::scriptError
    }
